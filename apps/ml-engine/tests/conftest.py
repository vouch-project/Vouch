...
_TEST_ENV = {
    ...
    # Pin to a nonexistent path so CreditScorer always starts in no-model mode
    # regardless of whether a real artifact exists locally.
    "ARTIFACT_PATH": "/nonexistent/artifact/path",
}
